...
<div class="row">
        <div class="col-lg-5 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="students_view.php" class="small-box-footer"><h2>More info</h2> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-5 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="units_view.php" class="small-box-footer"><h2>More info</h2> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-5 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="courses_view.php" class="small-box-footer"><h2>More info</h2>  <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-5 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="Marks_view.php" class="small-box-footer"><h2>More info</h2>  <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
  ...
  <div class="box box-solid bg-blue">
            <div class="box-header">
              ...
              <h1 class="box-title">Calendar</h3>
              <!-- tools box -->
