...
.main-sidebar
{
  ...
  <title><?php echo ucwords('TequedLabs Management System'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       <!--  <li class="header"><h3>HEADER</h3></li> -->
        ...
        <li><a href="units_view.php"><i class="fa fa-book"></i> <span>College</span></a></li>
        <li><a href="courses_view.php"><i class="fa fa-pencil"></i> <span>Branches</span></a></li>
        <li><a href="attendance_view.php"><i class="fa fa-pie-chart"></i> <span>Attendance Record</span></a></li>
        <li><a href="Marks_view.php"><i class="fa fa-edit"></i> <span>Details</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li> <a class="btn navbar-btn btn-default" href="<?php echo PREPEND_PATH; ?>first.html"><i class="glyphicon glyphicon-log-out"></i> <?php echo $Translation['sign out']; ?></a></li>
          </ul>
        </li>
      </ul>
