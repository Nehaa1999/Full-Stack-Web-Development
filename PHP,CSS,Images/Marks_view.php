...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsCSV = array(   
		"`Marks`.`id`" => "id",
		"`Marks`.`name`" => "Course name",
		"IF(    CHAR_LENGTH(`units1`.`name`), CONCAT_WS('',   `units1`.`name`), '') /* Unit */" => "college",
		"IF(    CHAR_LENGTH(`students1`.`name`), CONCAT_WS('',   `students1`.`name`), '') /* Student */" => "student",
		"IF(    CHAR_LENGTH(`students1`.`regno`), CONCAT_WS('',   `students1`.`regno`), '') /* Regno */" => "regno",
		"IF(    CHAR_LENGTH(`students1`.`year`), CONCAT_WS('',   `students1`.`year`), '') /* Year */" => "year",
		"`Marks`.`marks`" => "trainer",
	...
	$x->ColCaption = array("Name", "Unit", "Student", "Regno", "Year", "Trainer","       ", "Academicyear", "Fees Paid", "Date");
	$x->ColFieldName = array('name', 'unit', 'student', 'regno', 'year', 'Trainer','       ', 'academicyear', 'semester', 'date');
